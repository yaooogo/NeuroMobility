...
const MANAGE_MENU_PERMISSIONS = [
  ...
  { key: "help-articles", label: "帮助中心" },
  { key: "help-articles-create", label: "帮助中心-新增" },
  { key: "help-articles-update", label: "帮助中心-编辑" },
  { key: "help-articles-delete", label: "帮助中心-删除" },
  { key: "about", label: "关于我们" },
  { key: "about-create", label: "关于我们-新增" },
  { key: "about-update", label: "关于我们-编辑" },
  { key: "about-delete", label: "关于我们-删除" },
  { key: "vehicles", label: "车辆详情" },
  { key: "vehicles-create", label: "车辆详情-新增" },
  { key: "vehicles-update", label: "车辆详情-编辑" },
  { key: "vehicles-delete", label: "车辆详情-删除" },
...
const ROUTE_PERMISSION_RULES = [
  ...
  { path: "/help-article/create", permissions: ["help-articles-create"], exact: true },
  { path: "/help-article/update", permissions: ["help-articles-update"], exact: true },
  { path: "/help-article/delete", permissions: ["help-articles-delete"], exact: true },
  { path: "/help-article", permissions: ["help-articles"] },
  { path: "/about/create", permissions: ["about-create"], exact: true },
  { path: "/about/update", permissions: ["about-update"], exact: true },
  { path: "/about/delete", permissions: ["about-delete"], exact: true },
  { path: "/about", permissions: ["about"] },
  { path: "/vehicle/create", permissions: ["vehicles-create"], exact: true },
  { path: "/vehicle/update", permissions: ["vehicles-update"], exact: true },
  { path: "/vehicle/delete", permissions: ["vehicles-delete"], exact: true },
  { path: "/vehicle/upload-image", permissions: ["vehicles-create", "vehicles-update"], exact: true },
  { path: "/vehicle", permissions: ["vehicles"] },
  ...
  { path: "/wallet/tree", permissions: ["wallet-network"], exact: true },
