...
.dividend-header { height: 84px; display: grid; grid-template-columns: 42px 1fr 42px; align-items: end; padding: max(15px, env(safe-area-inset-top)) 0 19px; }
.dividend-header h1 { margin: 0; color: #111014; font-size: 22px; line-height: 31px; text-align: center; }
...
.dividend-summary { position: relative; min-height: 136px; display: grid; grid-template-columns: 1fr 1px 1fr; align-items: center; padding: 0 28px; border: 1px solid #dfceff; border-radius: 16px; background: linear-gradient(145deg, rgba(255,255,255,.86), rgba(227,221,255,.94)); overflow: hidden; }
...
.dividend-summary span { font-size: 14px; }
.dividend-summary strong { margin-top: 7px; color: #7f25d8; font-size: 27px; line-height: 1; }
...
.dividend-record img { width: 44px; height: 44px; display: block; object-fit: contain; filter: drop-shadow(0 4px 5px rgba(82,18,139,.18)); }
.dividend-record time { font-size: 14px; }
.dividend-record strong { color: #9345e7; font-size: 16px; white-space: nowrap; }
.dividend-empty { margin: 76px 0 0; color: #aaa2ae; font-size: 14px; text-align: center; }
@media (max-width: 390px) {
  .dividend-view { padding-left: 11px; padding-right: 11px; }
  .dividend-summary { padding-left: 14px; padding-right: 14px; }
  .dividend-summary span { font-size: 12px; }
  .dividend-summary strong { font-size: 23px; }
  .dividend-record { grid-template-columns: 39px minmax(0,1fr) auto; gap: 8px; padding-left: 12px; padding-right: 12px; }
  .dividend-record img { width: 39px; height: 39px; }
  .dividend-record time { font-size: 12px; }
  .dividend-record strong { font-size: 13px; }
}
</style>
